...
export default function FeedbackStep({
  ...
  const isBranchConfirmed = confirmedBranch === selectedBranch;
...
{(activeTab === 'select' || activeTab === 'org' || activeTab === 'person') ? (
  <>
    ...
    {/* Title */}
    <div className="text-center lg:text-left mt-6 lg:mt-0 mb-5 lg:mb-7">
    ...
    <div className="grid grid-cols-2 gap-4 mx-5 lg:mx-0 mb-4">
      <button 
    ...
    {activeTab === 'org' && (
      <div className={`${feedbackType === 'Талархал' ? 'mt-7' : 'mt-12'} animate-fadeIn lg:max-w-[680px] lg:ml-auto lg:mr-10`}>
        {/* Title */}
    ...
    {activeTab === 'person' && (
      <div className="mt-8 animate-fadeIn lg:max-w-[760px] lg:ml-auto lg:mr-10">
        {/* Title */}
        ...
        <div className="mx-5 mb-4 bg-[#0A50BF] rounded-2xl px-1 pt-4 pb-4 border border-white/10 shadow-[inset_7px_7px_16px_rgba(0,31,92,0.32),inset_-7px_-7px_16px_rgba(80,140,255,0.22),0_12px_24px_rgba(0,28,86,0.18)]">
          ...
          <div className="flex items-center justify-center gap-2 px-3">
            <button onClick={() => setSelectedBranch(prev => prev <= 0 ? branches.length - 1 : prev - 1)} className="w-11 h-11 rounded-full bg-white/15 backdrop-blur-sm text-white/90 hover:text-white hover:bg-white/25 transition-colors flex items-center justify-center animate-carousel-control-breathe flex-shrink-0">
            ...
            >
              ...
              <div className="absolute inset-0 flex items-end justify-center pb-4">
                <button
                  ...
                  onClick={(e) => {
                    e.stopPropagation();
                    setConfirmedBranch(selectedBranch);
                  }}
            ...
            <button onClick={() => setSelectedBranch(prev => (prev + 1) % branches.length)} className="w-11 h-11 rounded-full bg-white/15 backdrop-blur-sm text-white/90 hover:text-white hover:bg-white/25 transition-colors flex items-center justify-center animate-carousel-control-breathe flex-shrink-0">
          ...
          <p className="font-montserrat text-white text-sm font-black text-center mt-6 mb-2">{branches[selectedBranch]} салбар</p>
        </div>
