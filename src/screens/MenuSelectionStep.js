...
export default function MenuSelectionStep({ ads, adIndex, setAdIndex, onSelectFeedback, selectedAvatar, onBack }) {
  return (
<div className="w-full min-h-screen bg-[#0048BA] flex flex-col animate-fadeIn relative overflow-hidden">
  ...
  <div className="lg:px-56 xl:px-80 lg:pt-8">
  <AdCarousel ads={ads} adIndex={adIndex} setAdIndex={setAdIndex} className="mx-5 mt-6 lg:mx-0 lg:mt-0" desktopHeight="460px" />

  <div className="lg:pt-0">

  {/* Title text */}
  <div className="text-center mt-8 lg:mt-6 mb-6 lg:mb-6 mx-5 lg:mx-0">
    <h2 className="font-montserrat text-white text-xl lg:text-3xl font-black leading-snug lg:hidden">{`\u0422\u0430 \u0434\u043e\u043e\u0440\u0445 \u0446\u044d\u0441\u044d\u044d\u0441`}</h2>
    <h2 className="font-montserrat text-white text-xl lg:text-3xl font-black leading-snug lg:hidden">{`\u0441\u043e\u043d\u0433\u043e\u043b\u0442\u043e\u043e \u0445\u0438\u0439\u043d\u044d \u04af\u04af`}</h2>
    <h2 className="hidden lg:block font-montserrat text-white text-3xl font-black leading-snug whitespace-nowrap">{`\u0422\u0430 \u0434\u043e\u043e\u0440\u0445 \u0446\u044d\u0441\u044d\u044d\u0441 \u0441\u043e\u043d\u0433\u043e\u043b\u0442\u043e\u043e \u0445\u0438\u0439\u043d\u044d \u04af\u04af`}</h2>
  </div>

  {/* Three menu cards */}
  <div className="mx-5 lg:mx-0 grid grid-cols-2 lg:grid-cols-3 gap-3 lg:gap-12 xl:gap-16">
    {/* Хүсэлт илгээх */}
    <button
      onClick={() => onSelectFeedback('\u0425\u04af\u0441\u044d\u043b\u0442')}
      className="rounded-2xl overflow-hidden flex flex-col justify-end aspect-square lg:aspect-[16/9] transition-all hover:scale-[1.02] active:scale-[0.97] relative"
    ...
    <button
      ...
      className="rounded-2xl overflow-hidden flex flex-col justify-end aspect-square lg:aspect-[16/9] transition-all hover:scale-[1.02] active:scale-[0.97] col-span-1 relative"
